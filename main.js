...
function listarContatos(filtro = "", pesquisa = "") {
  ...
  listaDeContatos.forEach((contato, id) => {
    ...
    if (
      (filtroUpper === "NOME" && nomeContato.indexOf(pesquisaUpper) !== -1) ||
      (filtroUpper === "TELEFONE" && telefoneContato.indexOf(pesquisaUpper) !== -1) ||
      (filtroUpper === "EMAIL" && emailContato.indexOf(pesquisaUpper) !== -1) || 
      pesquisaUpper === ""
    ) {
